...
const initialState = {
  user:jwtDecode(localStorage.getItem('jwt')).full_name?  jwtDecode(localStorage.getItem('jwt')).full_name : null,
  directoryOpen: true,
  eventsOpen: false,
  newsOpen: false,
  signInOpen: false,
  ...
  admin: jwtDecode(localStorage.getItem('jwt')).is_admin?  jwtDecode(localStorage.getItem('jwt')).is_admin : false,
